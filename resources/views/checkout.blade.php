            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 mx-auto">
                <div id="pay-invoice" class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('checkout.payment') }}" method="post" novalidate="novalidate" class="needs-validation">
                            @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $("#payment-button").click(function(e) {
            ...
            if (!regCardName.test(CardName)) {
            
                $("#cc-name").addClass('required');
                $("#cc-name").focus();
